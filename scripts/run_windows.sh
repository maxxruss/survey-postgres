...
# CONTAINER_CONFIG_DIR="$CONTAINER_DIR/config"D:\projects\tender2\tender2-postgres\data

CONTAINER_DIR="../"
CONTAINER_CONFIG_DIR="$CONTAINER_DIR/config"
# DATA_DIR="/${PWD}/../data"
# DATA_DIR="D:\\projects\\tender2\\tender2-postgres\\data"
...
docker volume create --name pgdata-survey -d local
...
docker run \
    ...
    -v pgdata-survey:/var/lib/postgresql/data \
    --network=${NETWORK} \
    -p 54321:5432 \
    ${MY_IMAGE}
